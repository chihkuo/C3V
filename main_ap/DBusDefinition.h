...
#define GET_CONTRAST        "GetContrast"
#define GET_SATURATION      "GetSaturation"
#define GET_HUE             "GetHue"
#define GET_SHARPNESS       "GetSharpness"
#define GET_DENOISE         "GetDenoise"

#define SET_BRIGHTNESS      "SetBrightness"
#define SET_CONTRAST        "SetContrast"
#define SET_SATURATION      "SetSaturation"
#define SET_HUE             "SetHue"
#define SET_SHARPNESS       "SetSharpness"
#define SET_DENOISE         "SetDenoise"

#define GET_TELE_ZOOM_SPEED "GetTeleZoomSpeed"
#define GET_WIDE_ZOOM_SPEED "GetWideZoomSpeed"
#define SET_TELE_ZOOM_SPEED "SetTeleZoomSpeed"
#define SET_WIDE_ZOOM_SPEED "SetWideZoomSpeed"
...
//Tracking
#define GET_TRACKER_MODE    "GetTrackerMode"
#define SET_TRACKER_MODE    "SetTrackerMode"
#define GET_TRACKING_ID     "GetTrackingId"
#define SET_TRACKING_ID     "SetTrackingId"
#define SET_TRACKING_ROI    "SetTrackingRoi"
