...
typedef enum _gceFEATURE {
    ...
    gcvFEATURE_PE_DITHER_FIX, /*VIV: PE dither fix for RGB565 */
    ...
    gcvFEATURE_RS_DS_DOWNSAMPLE_NATIVE_SUPPORT, /*VIV: natively support depth/stencil downsample, no format conversion */
    ...
    gcvFEATURE_INTEGER32_FIX, /*VIV: separate R32I/RG32I from R32F/RG32F in tx, which swizzle_one is not correct */
    ...
    gcvFEATURE_RSBLT_MSAA_DECOMPRESSION, /*VIV: decompress msaa buffer but keep the SSB */
    gcvFEATURE_TILEFILLER_32TILE_ALIGNED, /*VIV: tile filler aligned to 32 tiles */
    gcvFEATURE_GEOMETRY_SHADER,
    gcvFEATURE_HALTI5, /*VIV: v60 main flag */
    ...
    gcvFEATURE_IMAGE_OUT_BOUNDARY_FIX, /*VIV: GPU hang when all image load out of image boundary */
    gcvFEATURE_TX_BORDER_CLAMP,
    gcvFEATURE_MSAA_SHADING,
    gcvFEATURE_ADVANCED_SH_INST, /*VIV: FMA, LDEXP, HALFMIX*/
    ...
    gcvFEATURE_PE_DITHER_FIX2, /*VIV: Dither fix for RGBA444 */
    gcvFEATURE_INDEX_FETCH_FIX, /*VIV: GPU hang when index fetching prematurelly terminated */
    ...
    gcvFEATURE_R8_UNORM, /*VIV: Support R8 in TX and PE. Actually TX R8 was in Halti2, But we choose to enable it togeter in halti5[v60]. */
    ...
    gcvFEATURE_MRT_8BIT_DUAL_PIPE_FIX, /*VIV: v60 has a bug for MRT has one(not all) 8bit RT with msaa off. single PE pipe would workaround it.*/
    ...
    gcvFEATURE_TEXTURE_BIAS_LOD_FIX,/* Features that are used for compiler. A fix for HW bug:1032. */
    gcvFEATURE_USE_GL_Z,
    ...
    gcvFEATURE_EVIS, /*VIV: VX support*/
    ...
    gcvFEATURE_TX_INTEGER_COORDINATE, /*VIV: src2(sampler replacement) must be immediate constant*/
    gcvFEATURE_PSIO_SAMPLEMASK_IN_R0ZW_FIX,
    gcvFEATURE_MULTI_CORE_BLOCK_SET_CONFIG,
    gcvFEATURE_SH_IMG_LDST_ON_TEMP,
    gcvFEATURE_TX_INTEGER_COORDINATE_V2, /*VIV: src2 could be temp and with different ISA op code to support different cordinate type*/
    ...
    gcvFEATURE_SH_CLOCK_GATE_FIX, /*VIV: must use with HALTI5 together */
    gcvFEATURE_GPIPE_CLOCK_GATE_FIX, /*VIV: must use with HALTI5 together */
    ...
    gcvFEATURE_SEPARATE_LS, /*VIV: Feature only for hardwares with USC supported */
    gcvFEATURE_PA_VARYING_COMPONENT_TOGGLE_FIX, /*VIV: HBN1163, previouly SWWA_1163 */
    gcvFEATURE_TX_MULTISAMPLER_FC_FIX, /*VIV: HBN1165, previously SWWA_1165 */
    gcvFEATURE_WIDELINE_TRIANGLE_EMU, /*VIV: not fix in projects.v621_v2 tree, but fixed in projects.v602.*/
    gcvFEATURE_FENCE,
    gcvFEATURE_MCFE,
    ...
    gcvFEATURE_IMAGE_LS_NO_FULLMASK_FIX, /*VIV: Image load/store without full mask has problem on v621_v2 */
    ...
    gcvFEATURE_MULTICORE_CONFIG, /*VIV: HW is released in a way that we wrap all core together */
    ...
    /*VIV: should be 'gcvFeature' not 'gcFEATURE' */
    /*VIV: should be 'gcvFeature' not 'gcFEATURE' */
    /*VIV: should be 'gcvFeature' not 'gcFEATURE' */
...
#if gcdTEST_DEC200
typedef enum _gceDEC200_COMMAND_CODES {
    gcvDEC200_CMD_START,
    gcvDEC200_CMD_STOP,
    gcvDEC200_COMPRESSION,
    gcvDEC200_DECOMPRESSION,
    gcvDEC200_FLUSH,
    gcvDEC200_FLUSH_DONE
} gceDEC200_COMMAND_CODES;
#endif
