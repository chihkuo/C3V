...
gcoHAL_GetProductName(IN gcoHAL Hal,
                      ...
                      OUT gctUINT *PID /*VIV: PID(projectID),aka customerID */);
...
#if VIVANTE_PROFILER_SYSTEM_MEMORY /*gcdENABLE_PROFILING*/
gceSTATUS
...
#if (VIVANTE_PROFILER_SYSTEM_MEMORY /*gcdENABLE_PROFILING*/ || gcdDEBUG)
/* Profile the heap. */
gceSTATUS
        ...
        { \
            ...
            { \
                ...
                { \
                    /* GS/TS must be bundled. */ \
                    attribBufSizeInKB = 42; \
                    attribCacheRatio = GCREG_USC_CONTROL_ATTRIB_CACHE_PAGES_EIGHTH; \
                } \
                else \
                { \
                    attribBufSizeInKB = 8; \
